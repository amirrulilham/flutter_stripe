...
extension StripeSdk {
    internal func buildPaymentSheetConfiguration(
        ...
        configuration.cardBrandAcceptance = StripeSdk.computeCardBrandAcceptance(params: params)
        ...
        if let customPaymentMethodConfig = params["customPaymentMethodConfiguration"] as? [String: Any] {
            configuration.customPaymentMethodConfiguration = StripeSdk.buildCustomPaymentMethodConfiguration(
    ...
    internal func preparePaymentSheetInstance(
        ...
        if let paymentIntentClientSecret = params["paymentIntentClientSecret"] as? String {
            ...
            let intentConfig = buildIntentConfiguration(
                ...
                captureMethod: StripeSdk.mapCaptureMethod(captureMethodString),
    ...
    func buildIntentConfiguration(
        ...
        if let amount = modeParams["amount"] as? Int {
            mode = PaymentSheet.IntentConfiguration.Mode.payment(
                ...
                setupFutureUsage: StripeSdk.setupFutureUsageFromString(from: modeParams["setupFutureUsage"] as? String ?? ""),
                captureMethod: captureMethod,
                paymentMethodOptions: StripeSdk.buildPaymentMethodOptions(paymentMethodOptionsParams: modeParams["paymentMethodOptions"] as? NSDictionary ?? [:])
            )
        } else {
